...
export const ADMIN_NOTIFICATIONS_CHANGED_EVENT = "fly-friendly-admin-notifications-changed";
...
function emitAdminNotificationsChanged(detail = {}) {
  if (typeof window === "undefined") {
    return;
  }

  window.dispatchEvent(new CustomEvent(ADMIN_NOTIFICATIONS_CHANGED_EVENT, { detail }));
}
...
export async function createAdminNotification(input = {}) {
  ...
  emitAdminNotificationsChanged({
    type: payload.type,
    recipientProfileId: payload.recipient_profile_id || null,
    recipientRole: payload.recipient_role || null,
  });
...
export async function markAdminNotificationRead(notificationId) {
  ...
  emitAdminNotificationsChanged({ notificationId });
  return true;
}
...
export async function markAllAdminNotificationsRead() {
  ...
  emitAdminNotificationsChanged({ markAll: true });
  return true;
}
